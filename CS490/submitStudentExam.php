...
$url = 'https://web.njit.edu/~jbt8/GetAnswer.php';
	...
	echo "var dumping the data in PHP \n";
	echo "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%";
...
// 	'Ans4' =>  "testing");
	...
	echo "\nPRINTING ENCODED SENDING ARRAY\n";
	$rawencode = rawurlencode($_GET['dataToSend']);
	echo $rawencode;
	echo "\nPRINTING ENCODED SENDING ARRAY\n";
	
	echo "\nPRINTING ENCODED SENDING ARRAY\n";
	echo $rawencode = rawurldecode($rawencode);
	echo "\nPRINTING ENCODED SENDING ARRAY\n";


	echo "HERE IS THE JSON ENCODED ARRAY";
	echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
	echo json_encode($sendingArray);
	$sendThisJSON=json_encode($sendingArray);
	echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
